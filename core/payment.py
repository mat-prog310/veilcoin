...
class LiquidityPool:
    ...
    def save(self):
        ...
        with open(self.data_path, 'w') as f:
            json.dump({'pool_veil': self.pool_veil, 'pool_eur': self.pool_eur,
                       'sell_offers': self.sell_offers, 'buy_offers': self.buy_offers,
                       'swaps': self.swaps[-100:], 'price_history': self.price_history[-100:]}, f, indent=2)
    ...
    def get_pool_info(self):
        return {'pool_veil': self.pool_veil, 'pool_eur': self.pool_eur,
                'veil_price': self.get_veil_price(), 'total_swaps': len(self.swaps)}
